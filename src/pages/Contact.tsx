              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid gap-5 sm:grid-cols-2">
                    <Input name="name" placeholder="Your Name *" value={formData.name} onChange={handleChange} required className="h-12 rounded-xl" />
                    <Input name="phone" type="tel" placeholder="Phone Number *" value={formData.phone} onChange={handleChange} required className="h-12 rounded-xl" />
                  </div>
                  <div className="grid gap-5 sm:grid-cols-2">
                    ...
                    <Input name="fromCity" placeholder="From (Departure City) *" value={formData.fromCity} onChange={handleChange} required className="h-12 rounded-xl" />
                  </div>
                  <div className="grid gap-5 sm:grid-cols-2">
                    ...
                    <Input name="travelDate" type="date" placeholder="Travel Date" value={formData.travelDate} onChange={handleChange} className="h-12 rounded-xl" />
                  </div>
                  <div className="grid gap-5 sm:grid-cols-2">
                    <Input name="travelers" type="number" min="1" placeholder="Number of Travelers" value={formData.travelers} onChange={handleChange} className="h-12 rounded-xl" />
